...
function renderCalendar() {
    ...
    if (dayOfWeek === 0) { // If today is Sunday
        currentWeekStart.setDate(today.getDate()); // Only highlight today
        currentWeekEnd.setDate(today.getDate()); // Only highlight today
    } else if (dayOfWeek === 1) { // If today is Monday
        currentWeekStart.setDate(today.getDate()); // Highlight Mon-Sun
        currentWeekEnd.setDate(today.getDate() + 6);
    } else { // If today is Tue-Sat
        currentWeekStart.setDate(today.getDate() - 1); // Highlight today
        currentWeekEnd.setDate(today.getDate() + (7 - dayOfWeek)); // Highlight through Sunday
    }
